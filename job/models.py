...
class job(models.Model):
    ...
    hired_service_provider = models.ForeignKey(users, to_field="email", related_name='service_provider', null=True, blank=True, on_delete=models.CASCADE)
    applicants = models.TextField(null=True, blank=True)
